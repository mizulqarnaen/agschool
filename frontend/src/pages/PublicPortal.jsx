      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-10 pb-16 space-y-16">
        ...
        <div className="pt-6 border-t border-slate-800/40">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-400 text-[11px] font-bold mb-2">
              ...
              <h2 className={`text-xl sm:text-2xl font-extrabold flex items-center gap-2 ${
                ...
                <Award className="w-6 h-6 text-purple-500" /> Brand Ambassador AG School
              </h2>
              <p className={`text-xs sm:text-sm ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-16 h-16 rounded-2xl overflow-hidden bg-slate-900 border-2 border-purple-500/40 p-0.5 shrink-0 shadow-lg glow-purple group-hover:scale-105 transition-transform">
                        <img
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs font-semibold text-purple-600 dark:text-purple-400 truncate mb-1">
                          {ba.title || 'Official Brand Ambassador'}
                        </p>
                        <span className={`inline-flex items-center gap-1 text-[11px] px-2 py-0.5 rounded-lg border font-mono ${
                          isDark ? 'bg-slate-900/90 text-cyan-300 border-cyan-500/30' : 'bg-slate-100 text-cyan-800 border-cyan-300'
                        }`}>
                          <UserCheck className="w-3 h-3 text-cyan-500" /> @{ba.roblox_username}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className={`pt-4 mt-2 border-t flex items-center justify-between gap-2 ${
                    ...
                    <Link
                      ...
                      className={`inline-flex items-center gap-1 text-xs font-bold hover:underline transition-all ${
