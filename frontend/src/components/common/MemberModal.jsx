...
import { Users, Plus, Trash2, Edit, UserCheck, Settings, X, Gamepad2, Video, Search, Filter, Phone, Mail, DollarSign, CreditCard, MessageSquare, Trophy, ShieldAlert } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Cari nama, IGN, Roblox ID, no HP, rekening..."
                value={searchQuery}
        ...
        <div className="lg:col-span-5 glass-panel p-5 rounded-2xl border border-slate-800 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              <label className="block text-[11px] font-semibold text-slate-300 uppercase mb-1">Nama Lengkap / Nama Tim *</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-[11px] font-semibold text-slate-300 uppercase mb-1">In-Game Nickname / Tag IGN (Opsional)</label>
              <input
                type="text"
                placeholder="contoh: YeemMKJZT_ID"
                value={formData.ign_tag}
                onChange={(e) => setFormData({ ...formData, ign_tag: e.target.value })}
                className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-xl text-xs text-emerald-300 font-mono font-bold focus:outline-none focus:border-cyan-500"
              />
            </div>

            <div>
              <label className="block text-[11px] font-semibold text-slate-300 uppercase mb-1">
                Role / Peran (Bisa Pilih Lebih Dari 1) *
              </label>
            ...
            {/* Optional Per-Role Salary / Honor Benchmark (Only relevant if staff or paid roles) */}
            {formData.member_type === 'Staff' && (
            ...
            <div className="p-3 bg-slate-900/80 rounded-xl border border-amber-500/30 space-y-2.5">
              <span className="text-[11px] font-bold text-amber-400 uppercase block flex items-center gap-1">
                <CreditCard className="w-3.5 h-3.5" /> Informasi Rekening Pembayaran Hadiah / Gaji
              </span>
              <div className="grid grid-cols-2 gap-2">
                <div>
            ...
            <div className="p-3 bg-slate-900/80 rounded-xl border border-slate-800 space-y-2.5">
              <span className="text-[11px] font-bold text-cyan-400 uppercase block">Kontak & Roblox / Discord (Opsional)</span>
              <div className="grid grid-cols-2 gap-2">
                <div>
                ...
                <div>
                  <label className="block text-[10px] font-semibold text-slate-400 uppercase mb-0.5">Discord Handle</label>
                  <input
                    type="text"
