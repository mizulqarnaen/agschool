...
## Recent Changes
- 015-searchable-recipient-select-in-expenses: Replaced standard recipient dropdown in `ExpensePage.jsx` modal form with a real-time **Searchable Recipient Select** component (supporting instant search by full name, IGN tag, bank account, and entity type).
