...
<!--
  ...
  brd.md if it doesn't belong here.
-->
...
<!--
  ...
  Folder is the module-slug used under docs/brd/modules/<slug>/.
-->

| Module | Folder | Description | Docs |
| ------ | ------ | ------------ | ---- |
| [Module 1] | `[module-slug]` | [1-line description] | [brd](modules/[module-slug]/brd.md) · [flow](modules/[module-slug]/flow.md) · [technical](modules/[module-slug]/technical.md) |

## System Architecture

<!--
  ACTION REQUIRED: High-level only - overall tech stack, deployment topology,
  and how modules relate to each other and to external systems. Module-internal
  architecture (layers, patterns) belongs in that module's technical.md, not here.
-->
...
<!--
  ...
  *.csproj, etc.) and list the major/direct dependencies with the version
  ...
  Module-specific dependencies belong in that module's technical.md instead;
...
<!--
  ...
  belong in that module's brd.md.
-->
...
<!--
  ...
  as a whole. Module-specific gaps belong in that module's brd.md.
-->
...
<!--
  Maintained by /rudis.brd on each re-run against an existing docs/brd/.
